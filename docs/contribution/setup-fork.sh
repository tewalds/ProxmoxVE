...
# upstream   https://github.com/tewalds/ProxmoxVE.git (fetch)
# upstream   https://github.com/tewalds/ProxmoxVE.git (push)
```
...
print_info "Upstream: https://github.com/tewalds/ProxmoxVE"
echo ""
