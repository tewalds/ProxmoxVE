...
```bash
#!/usr/bin/env bash
source <(curl -fsSL https://raw.githubusercontent.com/tewalds/ProxmoxVE/feature/kiwix/misc/install.func)
...
- [Trip](https://github.com/tewalds/ProxmoxVE/blob/main/install/trip-install.sh)
- [Thingsboard](https://github.com/tewalds/ProxmoxVE/blob/main/install/thingsboard-install.sh)
- [UniFi](https://github.com/tewalds/ProxmoxVE/blob/main/install/unifi-install.sh)
