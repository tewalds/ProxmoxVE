...
- Use [AppName.sh](https://github.com/tewalds/ProxmoxVE/blob/main/docs/contribution/templates_ct/AppName.sh) and [AppName-install.sh](https://github.com/tewalds/ProxmoxVE/blob/main/docs/contribution/templates_install/AppName-install.sh) as templates when creating new scripts.

---

# 🚀 The Application Script (ct/AppName.sh)

- You can find all coding standards, as well as the structure for this file [here](https://github.com/tewalds/ProxmoxVE/blob/main/docs/contribution/templates_ct/AppName.md).
...
- You can find all coding standards, as well as the structure for this file [here](https://github.com/tewalds/ProxmoxVE/blob/main/docs/contribution/templates_install/AppName-install.md).
...
Start with the [template script](https://github.com/tewalds/ProxmoxVE/blob/main/docs/contribution/templates_install/AppName-install.sh)
...
- [CT Template: AppName.sh](https://github.com/tewalds/ProxmoxVE/blob/main/docs/contribution/templates_ct/AppName.sh)
- [Install Template: AppName-install.sh](https://github.com/tewalds/ProxmoxVE/blob/main/docs/contribution/templates_install/AppName-install.sh)
- [JSON Template: AppName.json](https://github.com/tewalds/ProxmoxVE/blob/main/docs/contribution/templates_json/AppName.json)
